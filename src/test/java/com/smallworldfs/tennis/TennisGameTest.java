...
class TennisGameTest {
    ...
    void checkAllScoresTennisGameScriptLike(int player1Score, int player2Score, String expectedScore) {
        TennisGame game = new TennisGameScriptLike();
        checkAllScores(game, player1Score, player2Score, expectedScore);
    }

    @ParameterizedTest
    @MethodSource("possibleScoresAndExpectedScore")
    void checkAllScoresTennisGameInitial(int player1Score, int player2Score, String expectedScore) {
        TennisGame game = new TennisGameInitial("David", "player2");
        checkAllScores(game, player1Score, player2Score, expectedScore);
    }
